# 🎓 Certificaciones - Portfolio Profesional

[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT)

> Repositorio de certificaciones profesionales en ciberseguridad, desarrollo y tecnología.

## 📜 Contenido

Este repositorio contiene mis certificaciones y credenciales profesionales en:

- 🔒 **Ciberseguridad**: Certificaciones de seguridad informática
- 💻 **Desarrollo**: Certificados de programación y desarrollo
- ☁️ **Cloud Computing**: Certificaciones cloud (AWS, Azure, GCP)
- 📊 **Data Science**: Machine Learning e IA
- 🏛️ **Educación Formal**: Títulos académicos y cursos
